...
var root = new Vue({
    ...
    methods: {
        searchFilm: function() {
            this.searchResult = [];
            axios.get('https://api.themoviedb.org/3/search/movie?api_key=df59ca4f93077e59f74858e7b9ae9776&page=1&include_adult=false', { params: { query: this.searchedFilm } })
                .then((response) => {
            ...
            axios.get('https://api.themoviedb.org/3/search/tv?api_key=df59ca4f93077e59f74858e7b9ae9776&page=1&include_adult=false', { params: { query: this.searchedFilm } })
                .then((response) => {
